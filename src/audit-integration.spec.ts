...
describe("Audit Integration", () => {
  ...
  describe("Complete User Operations Flow", () => {
    it("should audit user creation without authentication", async () => {
      ...
      const auditRecord = {
        ...
        actorableId: undefined,
        actorableType: "User", // No authentication
        ip: undefined,
        userAgent: undefined,
        url: undefined,
        tags: undefined,
  ...
  describe("Error Handling", () => {
    it("should handle audit failures gracefully", async () => {
      ...
      mockAuditCreate.mockRejectedValueOnce(
      ...
      await expect(mockAuditCreate(auditRecord)).rejects.toThrow(

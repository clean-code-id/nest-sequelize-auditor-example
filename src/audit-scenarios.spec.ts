...
describe("Audit Scenarios", () => {
  ...
  describe("CREATE Operations", () => {
    ...
    it("should handle CREATE operation with full authentication", () => {
      ...
      expect(auditData.context.actorableId).toBe("user-123");
  ...
  describe("UPDATE Operations", () => {
    it("should handle UPDATE operation with onlyDirty: false (full state)", () => {
      ...
      expect(auditData.context.actorableId).toBe("admin-456");
  ...
  describe("DELETE Operations", () => {
    it("should handle DELETE operation with context", () => {
      ...
      expect(auditData.context.actorableId).toBe("moderator-101");
  ...
  describe("Configuration Scenarios", () => {
    ...
    it("should handle global vs per-model onlyDirty precedence", () => {
      ...
      const effectiveOnlyDirty =
        modelConfig.onlyDirty ?? globalConfig.onlyDirty ?? false;
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle rapid operations with different actors", () => {
      ...
      expect(operations[0].actorableId).toBe("user1");
      expect(operations[1].actorableId).toBe("user2");
      expect(operations[2].actorableId).toBe("user3");
    ...
    it("should handle system operations without actor", () => {
      ...
      expect(context.actorableId).toBeUndefined();
